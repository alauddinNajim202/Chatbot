...
body 
{
	background-image: url('https://static.vecteezy.com/system/resources/previews/020/436/116/original/chatbot-ai-artificial-intelligence-technology-hitech-concept-chatbot-application-smart-bot-open-ai-line-technology-abstract-design-for-chatting-web-banner-background-transformation-vector.jpg');
...
<body>
      ...
      <div class="container">
         <div class="row d-flex justify-content-md-center justify-content-center mb-8">
            <div class=" chatbot col-md-8" >

			<form class="myform" action="homepage.php" method="post">
					<input class="btn btn-warning mb-4" name="logout" type="submit" id="logout_btn" value="Log Out"/><br>					
			</form>
